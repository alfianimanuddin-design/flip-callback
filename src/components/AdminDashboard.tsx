...
export default function AdminDashboard() {
  ...
  const [revenueTrendDates, setRevenueTrendDates] = useState({
    start: "",
    end: "",
  });
  const [transactionStatusDates, setTransactionStatusDates] = useState({
    start: "",
    end: "",
  });
  const [dailyTransactionsDates, setDailyTransactionsDates] = useState({
    start: "",
    end: "",
  });
  ...
  const filterDailyData = (
    ...
    return data.filter((item) => {
      ...
      return (
        (!startDateStr || itemDateStr >= startDateStr) &&
  ...
  if (!stats) {
    return (
      <div style={{ textAlign: "center", padding: "40px" }}>
        ...
        <div style={{ fontSize: "18px", color: "#e53e3e", fontWeight: "600" }}>
  ...
  return (
    <div style={{ padding: "8px", background: "none" }}>
      <style jsx>{`
        @keyframes fadeIn {
          from {
            opacity: 0;
                  ...
                  style={{
                    ...
                    background:
                      selectedTimeRange === range.value
                        ...
                        : "white",
                    color:
                      selectedTimeRange === range.value ? "white" : "#1f2937",
                    cursor: "pointer",
              ...
              <div style={{ marginBottom: "24px" }}>
                ...
                >
                  <DailyTransactionsChart
                    data={filterDailyData(
                      stats.daily,
                      dailyTransactionsDates.start,
                      dailyTransactionsDates.end
                    )}
                  />
                </SimpleChartCard>
              </div>
              ...
              >
                ...
                >
                  <RevenueAreaChart
                    data={filterDailyData(
                      stats.daily,
                      revenueTrendDates.start,
                      revenueTrendDates.end
                    )}
                  />
                </SimpleChartCard>
                ...
                >
                  {(() => {
                    const filteredDaily = filterDailyData(
                      stats.daily,
                      transactionStatusDates.start,
                      transactionStatusDates.end
                    );
                  ...
                  {stats.products.length === 0 ? (
                    ...
                    stats.products.map((product, index) => {
                      const maxRevenue = Math.max(
                        ...stats.products.map((p) => p.revenue)
                      );
...
function SimpleChartCard({
  ...
  return (
    ...
    >
      ...
      >
        {icon && <span style={{ display: "flex", color: "#667eea" }}>{icon}</span>}
        {title}
        {badge && (
          <span
            style={{
  ...
  if (total === 0) {
    return (
      <div style={{ textAlign: "center", padding: "40px", color: "#9ca3af" }}>
        ...
        >
          <PieChartIcon size={48} color="#9ca3af" />
        </div>
